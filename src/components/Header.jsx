        ...
        <div className="flex items-center space-x-4">
            {isAuthenticated ? (
              <>
                ...
                {/* Sliding User Panel */}
                <div
                  className={`fixed top-0 right-0 h-full w-64 bg-grey !bg-grey p-6 z-50 transform transition-transform duration-100 ${
                    showUserPanel ? 'translate-x-0' : 'translate-x-full'
                  }`}
                  style={{ backgroundColor: 'white', opacity: 1, border: blue, borderStyle: 'solid', borderWidth: 1 }}
                >
                  <button
                    onClick={closeUserPanel}
